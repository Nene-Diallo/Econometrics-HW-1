...
# Name: Nene Diallo
#Group Members: Arifa Begum, Leo Alcaide, Maria Camila, Sun Wo Kim 


# For the dice experiment, I decided to first to burn it and then smash it
using a knife. I did this because i wnated to see how the bumbers that popped
up would differ from the two #dice as dice 1 was the control and dice 2 was the
#experimental. BY making one side uneven, I wanted to see if this would change
the numbers that kept popping up. 
...
#Thoughts
#One thing that stood out to me is that The average birth year for both men 
#and women is 1970, suggesting that the people survyed are probabaly all
#around the same age. 
